...
bli material --action create|assign|list          # マテリアル（create は PBR/テクスチャ可: --metallic --roughness --emission r,g,b,a --alpha --texture <img> --pack-texture）
bli modifier --action add|remove|list|apply       # モディファイア（任意 type 可: --type BEVEL --props '{"width":0.1,"segments":2}'＝rna 検証・結果 applied_props に実値）
